...
struct VertexInfo
{
	int stride;
	int size;
	std::vector<std::vector<double>> vec_vertex;
};
...
struct TexcoordInformation
{
	int stride;
	int size;
	std::vector<std::vector<double>> vec_texcoord;
};
...
{
	int stride;
	std::vector<double> vec_post_matrix_input_data;
};
...
{
	int stride;
	std::vector<double> vec_post_matrix_output_data;
};
...
std::vector<double> vec_skin_bind_poses; //bind poses
std::vector<double> vec_skin_weights; //weights
