//Gray Scaling effect with weighted channels
//average is calculated using 0.2126 * texColor.r + 0.7151 * texColor.g + 0.0722 * texColor.b in fragment shader
#include<windows.h>
...
void createFragmentShader()
{
	...
	const GLchar *fragmentShaderSourceCodeForQuad =
		...
		"{" \
		"vec4 texColor = texture(u_sampler_texture, out_tex_coords);"
		"float average = (0.2126 * texColor.r + 0.7151 * texColor.g + 0.0722 * texColor.b);"\
