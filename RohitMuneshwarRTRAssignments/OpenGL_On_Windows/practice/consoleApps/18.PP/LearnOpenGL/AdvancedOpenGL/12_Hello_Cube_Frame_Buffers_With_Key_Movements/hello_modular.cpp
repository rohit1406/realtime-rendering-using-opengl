...
{
	//function prototypes
	void configureBoxVao(GLfloat *vertexData);
	void configureFloorVao(GLfloat *floorVertices);
	void configureGrassVao(GLfloat *grassVertices);
	...
	configureBoxVao(vertexData);
	configureFloorVao(floorVertices);
	configureGrassVao(grassVertices);
