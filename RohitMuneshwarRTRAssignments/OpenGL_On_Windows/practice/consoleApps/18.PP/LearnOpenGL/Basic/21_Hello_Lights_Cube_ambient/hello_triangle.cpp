...
GLuint gObjectColorUniform, gLightColorUniform;
...
void initialize(){
	...
	gLightColorUniform = glGetUniformLocation(gShaderProgramObject, "u_light_color");
...
void display(){
	...
	//scale light source
	rotationMatrix = rotate(-58.0f, 1.0f, 0.0f, 0.2f);
	...
	glUniform3fv(gLightColorUniform, 1, vec3(1.0f, 1.0f, 1.0f));
