...
GLuint gEbo;
GLuint gVbo_col;
GLuint gMVPUniform, gSamplerUniform;
...
void initialize(){
	...
	const GLchar *fragmentShaderSourceCode =
				...
				"void main(void)" \
				"{" \
				"FragColor=texture(u_sampler_texture, out_tex_coords) * vec4(out_color, 1.0);" \
				"}";
...
void loadTexture(GLuint *texture)
{
	...
	GLubyte* data = stbi_load("container.jpg", //location of the input file
							&width,
							&height,
