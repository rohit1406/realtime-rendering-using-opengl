...
GLuint gObjectColorUniform, gLightColorUniform, gLightDiretionUniform, gViewerPositionUniform;
...
void initialize(){
	...
	gLightDiretionUniform = glGetUniformLocation(gShaderProgramObject, "u_light_direction");
...
void display(){
	...
	glUniform3fv(gLightDiretionUniform, 1, lightDir);
