//
//  GLESView.m
//  iOS_PP_11_Persp_Texture_Tweak_Smiley_03062018
//
...
-(id) initWithFrame:(CGRect)frame
{
    ...
    if(self)
    {
        ...
        //load textures
        gTextureSmiley=[self loadTextureFromBMPFile:@"smiley" :@"bmp"];
...
-(void) drawView:(id)sender
{
    ...
    glUniform1i(texture_sampler_uniform, 0); // 0th sampler enable ( as we have only 1 texture sampler in fragment shader )
